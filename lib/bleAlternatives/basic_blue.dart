...
class MyBasicBlue extends StatefulWidget {
  @override
  _MyBasicBlueState createState() => _MyBasicBlueState();
}

class _MyBasicBlueState extends State<MyBasicBlue> {
  ...
  String getAdress(BluetoothDevice d) {
